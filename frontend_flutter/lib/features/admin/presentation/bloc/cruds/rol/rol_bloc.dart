...
import 'package:infotel_flutter/features/admin/presentation/bloc/cruds/rol/rol_state.dart';
...
class RolBloc extends Bloc<RolEvent, RolState> {
  ...
  RolBloc({
    ...
    assert(buscarRolesPorNombreUsecase != null, 'buscarRolesPorNombreUsecase es null');
